...
export const nav = [
  { n: "01", label: "Start", href: "/" },
  { n: "02", label: "Leistungen", href: "/leistungen" },
  { n: "03", label: "Team", href: "/team" },
  { n: "04", label: "Ergebnisse", href: "/ergebnisse" },
  { n: "05", label: "Aktuelles", href: "/aktuelles" },
  { n: "06", label: "Über uns & Kontakt", href: "/ueber-uns" },
];
